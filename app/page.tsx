...
export default async function Home({
    ...
    const page =
        (searchParams.page && parseInt(searchParams.page as string)) || 34;
    const per_page =
